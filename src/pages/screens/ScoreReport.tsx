 ...
 *   처음 입력이 앱인 것은 맞다. 다만 **직원이 수정할 경로가 아직 없다**(admin 은 조회만).
 *   장학 취소 판정이 이 등급을 근거로 도는데 잘못 들어간 값을 고칠 사람이 없다 — API_GAPS 12-1.
 *
        ...
        <section className="panel">
          ...
          <div className="panel-body">
            <div className="upload-note">
              ...
              <div>
                성적은 <b>학생이 앱에서 직접 입력</b>하고, <b>수정은 직원을 통해</b> 하도록 정해져 있습니다
                (2026-08-26 회신). 다만 <b>직원이 수정하는 경로가 아직 없어</b> 지금은 조회만 됩니다.
                장학 판정이 이 등급을 근거로 하므로, 잘못 입력된 값은 백엔드 반영 후 고칠 수 있습니다.
              </div>
            </div>
