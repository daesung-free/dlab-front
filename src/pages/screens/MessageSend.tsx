...
const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    status: '승인',
    body: '[DLab] {학생명} 학생이 {시각}에 지각 등원했습니다. 사유가 있으시면 회신 부탁드립니다.',
    vars: ['학생명', '시각'],
    updatedAt: '2026-04-18',
    updatedBy: '본사',
  },
  {
    ...
    status: '심사대기',
    body: '[DLab] {학생명} 학생이 금일 미등원 상태입니다. 확인 부탁드립니다.',
    vars: ['학생명'],
  ...
  },
  {
    ...
    status: '반려',
    body: '[DLab] {일자} 급식 신청이 마감됩니다. 앱에서 신청해 주세요.',
    vars: ['일자'],
      ...
      {tab === 'log' && (
        <>
          ...
          <div className="note-box">
            등원·승인·상담 같은 <b>사건이 일어날 때 자동으로 나간 알림</b>이 날짜·사유별로 묶여 있습니다.
            보류는 카카오 템플릿 심사가 끝나지 않은 건으로, 심사가 통과되면 그대로 나갑니다.
          </div>
